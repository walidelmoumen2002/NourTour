    ...
    return (
        <div id="why" className="bg-[#156782] ">
            <div className="mx-auto block w-full">
                <h2 className="font-montserrat font-bold md:text-5xl text-4xl text-[#f1f0e4] py-20 text-center" >Why <span className="text-[#ff9a23]">Choose</span> Us? </h2>
                <div className="flex flex-col flex-wrap items-center md:flex-row md:justify-evenly py-5 md:py-20 ">
                    <div className="bg-[#f1f0e4] h-80 w-80 flex flex-col items-center rounded-xl p-10 mb-16 md:mb-0">
