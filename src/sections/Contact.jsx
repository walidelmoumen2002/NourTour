    ...
    return (
        <div id="contact" className="text-[#f1f0e4] flex flex-col md:flex-row items-center justify-around py-16 md:py-32">
            <div className='font-montserrat'>
                <h2 className="font-bold text-4xl md:text-5xl text-[#156782] text-center md:pb-10 md:text-start" >Get In Touch</h2>
                <div className="flex  p-10 flex-col font-montserrat mb-10 md:p-0 md:m-0">
