    ...
    return (
        <div id="contact" className="text-[#f1f0e4] flex flex-col md:flex-row items-center justify-around py-16 md:py-32">
            <div className='font-montserrat '>
                ...
                <div className="flex flex-col items-center font-montserrat mb-10 md:p-0 md:m-0">
                    <a href='tel:+212638-683227' className=" bg-[#156782] rounded-md hover:shadow-xl flex flex-row items-center h-20 md:text-left px-5 md:px-10 py-3 w-5/6 md:w-full">
                    ...
                    <button onClick={() => window.location = 'mailto:noureddinelassaoui81@gmail.com'} className=" bg-[#156782] rounded-md hover:shadow-xl flex flex-row items-center h-20 text-left px-5 md:px-10 py-3 w-5/6 md:w-full">
                    ...
                    <a href='https://maps.app.goo.gl/RQzyemfGhYpBMF5T7?g_st=ic' className=" bg-[#156782] rounded-md hover:shadow-xl flex flex-row items-center h-20  md:text-left px-5 md:px-10 py-3 w-5/6 md:w-full">
