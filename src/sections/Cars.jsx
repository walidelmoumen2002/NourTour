      ...
      <div className='container flex items-center justify-around mx-auto'>
        <div className="w-1/2 p-10 container flex flex-col justify-center">
          ...
          <Link
            ...
            smooth={true}
            duration={500}
            className="px-5 py-2 mt-2 text-base font-roboto cursor-pointer font-bold leading-7 w-fit text-white transition-all duration-200 bg-[#ff9a23] hover:bg-gray-600 border border-transparent rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
            role="button"
          >
            Contactez-nous
          </Link>
